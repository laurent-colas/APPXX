...
//Connaitre le choix de l’utilisateur sur le type de données//
void ObtenirType(int *Type)
{
...
//Connaitre le choix de l’utilisateur sur le format des opérandes//
...
//Connaitre le choix de l’utilisateur sur l’opération//
void ObtenirOperation(int *Operation)
{
...
//Concaténer l’information sur le type et le format de données en une seule information//
int ConvertirListe(int *Liste) {
